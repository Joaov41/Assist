...
struct OnboardingView: View {
    ...
    private let steps = [
        ...
        OnboardingStep(
            ...
            description: "AI Assistant needs accessibility access to detect text selection and enhance your experience.",
            isPermissionStep: true
        ),
        OnboardingStep(
            title: "Customize Your Experience",
            description: "Set up your preferred keyboard shortcut.",
            isPermissionStep: false
        )
    ]
    ...
    private var accessibilityStep: some View {
        VStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 15) {
                ...
                Text("3. Navigate to Applications and select AI Assistant")
                Text("4. Enable the checkbox next to AI Assistant")
            }
